...
use JardisSupport\DotEnv\Handler\CastStringToArray;
...
class CastStringToArrayTest extends TestCase
{
    ...
    public function testStringWithArrowWithoutBracketsRemainsString(): void
    {
    ...
    public function testZeroValueInArrayIsNotNull(): void
    {
        $input = "[key=>0]";
